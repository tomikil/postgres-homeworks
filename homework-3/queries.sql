...
SELECT customers.company_name AS customers, CONCAT(employees.first_name, ' ', employees.last_name) AS employee
FROM orders
INNER JOIN customers USING(customer_id)
INNER JOIN employees USING(employee_id)
INNER JOIN shippers ON ship_via=shippers.shipper_id
